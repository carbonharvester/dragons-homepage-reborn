...
export const day1 = {
  ...
  activities: [
    ...
    "Orientation: Introduction to the week ahead, the permaculture project, Kapes' mission, and Seeds2Education's role in addressing food insecurity for local students"
  ]
};
