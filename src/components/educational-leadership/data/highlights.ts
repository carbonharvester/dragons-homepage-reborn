...
export const tripHighlights: TripHighlight[] = [
  {
    icon: React.createElement(School, { className: "h-10 w-10 text-white" }),
  ...
  {
    icon: React.createElement(TreeDeciduous, { className: "h-10 w-10 text-white" }),
  ...
  {
    icon: React.createElement(Sun, { className: "h-10 w-10 text-white" }),
  ...
  {
    icon: React.createElement(Camera, { className: "h-10 w-10 text-white" }),
