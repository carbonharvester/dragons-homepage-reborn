    ...
    <section className="py-16 bg-slate-50">
      <div className="container-wide">
        <div className="text-center mb-10">
          <h2 className="section-heading">Experience Our Programmes</h2>
        ...
        <div className="relative mx-auto max-w-4xl overflow-hidden rounded-xl shadow-xl">
          {isPlaying ? (
            <div className="aspect-video w-full">
              <iframe 
                src="https://player.vimeo.com/video/922795693?h=c4bc497777&autoplay=1" 
            ...
            <div className="relative">
              <AspectRatio ratio={16/9}>
                <div className="w-full h-full bg-black">
                  ...
                  <iframe 
                    src="https://player.vimeo.com/video/922795693?h=c4bc497777&background=1" 
                    className="w-full h-full pointer-events-none"
                    frameBorder="0"
                    title="Mission Kapes background video"
                  ></iframe>
                </div>
              </AspectRatio>
            </div>
