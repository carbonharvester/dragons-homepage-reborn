...
const SchoolTripsFeatures = () => {
  const features = [{
    ...
    points: ["Documentary photography and storytelling", "Collaborative art projects with communities", "Cultural immersion through creative expression"]
  }, {
    title: "Activity",
    icon: GraduationCap,
    description: "Immersive adventures that challenge students physically while exploring diverse landscapes and ecosystems.",
    points: ["Wildlife conservation activities", "Adventure challenges in natural environments", "Team-building through outdoor exploration"]
  }, {
    title: "Service",
    icon: School,
      ...
      <div className="container-wide">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => <div key={index} className="bg-white rounded-lg p-6 shadow-lg overflow-hidden transform transition-transform hover:scale-[1.02]">
                ...
                <ul className="space-y-2 mb-2">
                  {feature.points.map((point, pointIndex) => <li key={pointIndex} className="flex items-start">
