    ...
    <div className="max-w-3xl mx-auto text-center mb-16 mt-8">
      ...
      <div className="mt-12 p-8 bg-gradient-to-br from-dragon-beige/30 to-transparent rounded-lg shadow-sm">
        <h3 className="text-2xl font-academy text-dragon-dark mb-6 text-center relative">
          <span className="inline-block bg-dragon-yellow h-1 w-10 absolute -top-3 left-1/2 transform -translate-x-1/2"></span>
          Key Benefits
        </h3>
        <BulletList 
          items={keyBenefits}
          ...
          className="space-y-4"
          listItemClassName="flex items-start rounded-md p-3 transition-colors hover:bg-dragon-beige/40"
        />
      </div>
    </div>
  );
