...
const ProgramsMenu = () => {
  return (
    <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-screen max-w-7xl bg-white border-t border-gray-100 shadow-lg py-6 z-50 hidden lg:block">
