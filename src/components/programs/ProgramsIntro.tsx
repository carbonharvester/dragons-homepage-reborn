...
const ProgramsIntro = () => {
  return (
    <div className="text-center mb-12">
      ...
      {/* Enhanced introduction with decorative borders on main container */}
      <div className="mt-8 mb-12 max-w-4xl mx-auto relative">
        {/* African Pattern Border for main container */}
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm text-left relative z-10 border-2 border-dragon-beige print:border-2 print:border-black">
