...
const ProgramsIntro = () => {
  return (
    <div className="text-center mb-12">
      ...
      {/* Enhanced introduction with decorative borders */}
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm text-left relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="relative">
              {/* Decorative border for first box */}
              <div className="absolute inset-0 rounded-lg overflow-hidden">
              ...
              <div className="bg-dragon-beige/20 p-4 rounded-lg relative z-10">
            ...
            <div className="relative">
              {/* Decorative border for second box */}
              <div className="absolute inset-0 rounded-lg overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-2">
                  <img 
                    src="https://res.cloudinary.com/dng12bd0a/image/upload/v1751050160/b75c66c7-3895-4c95-9914-7537fdad9ba2_hcqch5.png" 
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="relative">
              {/* Decorative border for third box */}
              <div className="absolute inset-0 rounded-lg overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-2">
                  <img 
                    src="https://res.cloudinary.com/dng12bd0a/image/upload/v1751050160/b75c66c7-3895-4c95-9914-7537fdad9ba2_hcqch5.png" 
            ...
            <div className="relative">
              {/* Decorative border for fourth box */}
              <div className="absolute inset-0 rounded-lg overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-2">
                  <img 
                    src="https://res.cloudinary.com/dng12bd0a/image/upload/v1751050160/b75c66c7-3895-4c95-9914-7537fdad9ba2_hcqch5.png" 
