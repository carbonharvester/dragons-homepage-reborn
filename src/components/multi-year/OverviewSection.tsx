    ...
    <section className="py-16 bg-white">
      <div className="container-wide">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="w-20 h-1 bg-dragon mb-6"></div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-dragon">
              <Badge className="mb-3 bg-dragon text-white">Year 1</Badge>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-dragon">
              <Badge className="mb-3 bg-dragon text-white">Year 2</Badge>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-dragon">
              <Badge className="mb-3 bg-dragon text-white">Year 3</Badge>
