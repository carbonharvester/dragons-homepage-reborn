...
const KenyaMap = () => {
    ...
    newMap.on('load', () => {
      ...
      cities.forEach(city => {
        ...
        const cityPopup = new mapboxgl.Popup({
          ...
          `);
        new mapboxgl.Marker(cityMarkerElement).setLngLat([city.position.lng, city.position.lat]).setPopup(cityPopup).addTo(newMap);
      });
  ...
  return <div className="rounded-lg overflow-hidden border border-gray-200 shadow-lg">
      <AspectRatio ratio={16 / 9}>
        <div className="w-full h-full relative">
          ...
          {!mapLoaded && <div className="absolute inset-0 flex items-center justify-center bg-dragon-beige/20">
