          ...
          <div className="container-wide text-center">
            ...
            <div className="mt-12 relative overflow-hidden">
              <div className="w-full overflow-hidden">
                <div ref={scrollContainerRef} className="flex items-center gap-8 lg:gap-16 overflow-x-hidden whitespace-nowrap py-4 px-4" style={{
                scrollbarWidth: 'none',
                msOverflowStyle: 'none'
              }}>
                  {duplicatedLogos.map((logo, index) => <div key={index} className="flex-shrink-0 flex items-center justify-center">
                      <Avatar className={`rounded-none bg-transparent ${logo.scale ? 'h-28 w-28 md:h-36 md:w-36' : 'h-16 w-16 md:h-20 md:w-20'}`}>
                        <AvatarImage src={logo.src} alt={logo.alt} className="object-contain h-full w-full" />
