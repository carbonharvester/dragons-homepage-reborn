      ...
      <main className="flex-grow">
        ...
        <section className="bg-dragon-light py-16">
          <div className="container-wide">
            <h1 className="text-4xl md:text-5xl font-bold text-dragon-dark mb-4">Health and Safety</h1>
          ...
          <div className="container-wide">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-dragon-dark">Our Safety Approach</h2>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-16">
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-dragon-dark mb-4">Pre-Departure Preparation</h3>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-dragon-dark mb-4">On-Program Support</h3>
                  <ul className="space-y-3 text-dragon-gray">
                    <li className="flex items-start">
                      <span className="text-dragon mr-2">•</span>
          ...
          <div className="container-wide">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-dragon-dark">Health Information</h2>
              </div>
              
              <div className="mb-12">
                <h3 className="text-2xl font-bold text-dragon-dark mb-4">Vaccinations and Medications</h3>
              ...
              <div className="mb-12">
                <h3 className="text-2xl font-bold text-dragon-dark mb-4">Medical Facilities</h3>
              ...
              <div className="mb-12">
                <h3 className="text-2xl font-bold text-dragon-dark mb-4">Special Health Considerations</h3>
                <p className="text-dragon-gray mb-6">
        ...
        <section className="py-16">
          <div className="container-wide">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-dragon-dark mb-8">Safety Guidelines</h2>
              
              <div className="mb-12">
                <h3 className="text-2xl font-bold text-dragon-dark mb-4">General Safety Practices</h3>
                <p className="text-dragon-gray mb-6">
                ...
                <div className="space-y-6">
                  <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <h4 className="font-bold text-dragon-dark mb-2">Group Travel</h4>
                    <p className="text-dragon-gray">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <h4 className="font-bold text-dragon-dark mb-2">Communication</h4>
                    <p className="text-dragon-gray">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <h4 className="font-bold text-dragon-dark mb-2">Accommodations</h4>
                    <p className="text-dragon-gray">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <h4 className="font-bold text-dragon-dark mb-2">Transportation</h4>
                    <p className="text-dragon-gray">
              ...
              <div className="text-center mt-16">
                <h3 className="text-xl font-bold text-dragon-dark mb-4">Have more questions about health and safety?</h3>
                <p className="text-dragon-gray mb-6">
                ...
                <div className="flex justify-center gap-4">
                  ...
                  <a href="mailto:safety@kapesadventures.com" className="btn-primary">
                    Contact Safety Team
                  </a>
                </div>
              </div>
