  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main>
                      ...
                      <CardContent className="p-6 md:p-8">
                        ...
                        <div className="mt-6">
                          <Button 
                            ...
                            onClick={() => window.location.href = "#detailed-itinerary"}
                          >
        ...
        <section id="detailed-itinerary" className="py-16 bg-white">
          <div className="container-wide">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="section-heading">Detailed Daily Itinerary</h2>
              <p className="section-subheading">
                Explore our comprehensive day-by-day schedule for the 4-week Capturing Kenya program.
              </p>
            </div>
            
            <div className="space-y-12">
              {weeks.map((week) => (
                <div key={week.number} className="border border-gray-100 rounded-lg shadow-sm overflow-hidden">
                  <div className="bg-dragon p-6 text-white">
                    <h3 className="text-2xl font-bold">Week {week.number}: {week.title}</h3>
                    <p className="opacity-90">{week.subtitle}</p>
                  </div>
                  ...
                  <div className="divide-y divide-gray-100">
                    {week.days.map((day) => (
                      <div key={day.day} className="p-0">
                        <button 
                          className="w-full p-6 flex justify-between items-start hover:bg-gray-50 transition-colors text-left"
                          onClick={() => toggleDayDetails(`week${week.number}-day${day.day}`)}
                        >
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <span className="bg-dragon-beige rounded-full px-3 py-1 text-sm font-medium text-dragon">Day {day.day}</span>
