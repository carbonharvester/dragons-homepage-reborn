...
export const schoolTrips = [
  { title: "Food For Education", duration: "7-8 Days", season: "Jan-Oct", description: "Join sustainable agriculture initiatives to address food security challenges in rural communities through hands-on farming and education programmes.", image: "/lovable-uploads/15e3c0c3-6461-43da-866c-88c8a2129885.png", link: "/programs/food-for-education", icon: Globe },
  { title: "Community Conservation", duration: "7-8 Days", season: "Year Round", description: "Work alongside local conservation experts to protect endangered ecosystems while learning traditional ecological knowledge and sustainable practices.", image: "/lovable-uploads/5c2915df-6fcc-4fd9-a320-7025337ffd6a.png", link: "/programs/community-conservation", icon: Globe },
  { title: "Exploring Women's Empowerment", duration: "7-8 Days", season: "Year Round", description: "A transformative journey to support Zawadisha's microloan program for rural women while experiencing water walks, crafting workshops, and Tsavo's wildlife.", image: "/lovable-uploads/2b64c2a8-18d5-43cc-a376-e32137687104.png", link: "/programs/empowering-women", icon: Globe }
];

export const summerAbroad = [
  { title: "Feeding the Future", duration: "4 Weeks", season: "Jun 28 - Jul 25 2025", description: "Join sustainable agriculture initiatives to address food security challenges in rural communities through hands-on farming and education programmes.", image: "/lovable-uploads/15e3c0c3-6461-43da-866c-88c8a2129885.png", link: "/programs/feeding-the-future", icon: Globe, ageGroup: "17-21", location: "Kenya" },
  { title: "Capturing Kenya", duration: "3 Weeks", season: "Jun 28 - Jul 25 2025", description: "Develop your photography and videography skills with expert guidance as you document safari adventures, community experiences, and natural wonders across Kenya.", image: "/lovable-uploads/741a3f8a-9da4-4fa9-a3d2-363c5231bed5.png", link: "/programs/capturing-kenya", icon: Camera, ageGroup: "17-21", location: "Kenya" }
];
