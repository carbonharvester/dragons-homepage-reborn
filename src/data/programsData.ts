...
export const multiYearProgram = {
  ...
  years: [
    ...
    },
    {
      ...
      ageRange: "Ages 14–16",
      description: "Experience the Kapes Zawadisha Immersion in Tsavo, living alongside rural women and contributing to microloans. Earn the Kapes Development Certificate.",
      icon: Users
    },
    {
