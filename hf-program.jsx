...
const SLIM_PROGRAMMES = {
  ...
  cc: {
    ...
    gallery: [
      {src: IMG.ccSchoolGirls, cap: "Partner-school children · Kenyan-led conservancy",   pos:"center 30%"},
      {src: IMG.ccBuffalo,     cap: "Buffalo herd · Kenyan wildlife corridor",              pos:"center 50%"},
      {src: IMG.ccFactory,     cap: "Screen-printing · the carbon-neutral garment factory", pos:"center 40%"},
      {src: IMG.ccArborGroup,  cap: "Arbor School · 2023 + 2024 cohorts",                   pos:"center 30%"},
    ],
    quote: null,
    price: "USD 2,600",
