...
function KenyaTeam() {
  const team = [
    ...
    {img:IMG.f4eLogo, logoStyle:true, name:"Food for Education", role:"Programme partner · Kenyan NGO", org:true, note:"Kenyan NGO subsidising school meals at scale. Onions from the Seeds2Education farm are exchanged through their kitchen at $0.85/kg — equal to three subsidised school meals."},
